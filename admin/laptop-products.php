    ...
    <div class="card mt-4 shadow-sm">
        ...
        <div class="card-body">
            ...
            <div class="col-md-5 mb-3">
                ...
                <select name="brand_id" id="brand_id" class="form-select" onchange="filterLaptopProductsByBrand()">
            ...
            <div id="products-table">
                ...
                if (isset($_GET['brand_id']) && !empty($_GET['brand_id'])) {
                    ...
                    $query = "SELECT products.*, categories.cateName 
                              ...
                              WHERE categories.cateName = 'Laptop' AND products.brand_id = '$brand_id'";
                } else {
                    $query = "SELECT products.*, categories.cateName 
                              FROM products 
                              JOIN categories ON products.category_id = categories.id
                              WHERE categories.cateName = 'Laptop'";
                }
